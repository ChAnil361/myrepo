...
<div id="header" style="background:white;">
	...
	<img src="<?php echo e(asset('/storage/Spark_bank.jpg')); ?>" width="180" /><h1 style="color:black;margin:-110px;padding-left:280px;padding-top:30px;">Spark Banking System</h1>   
...
<div id="navigation" style="margin-top:-140px;">
    ...
    <?php endif; ?>
    <?php if(($k=Route::current()->getName()) == 'show'): ?>
    <form name="myform" method="post" action="<?php echo e(route('transaction_all')); ?>" >
        <?php echo csrf_field(); ?>
...
<center><img src="<?php echo e(asset('storage/view_bank_img.webp')); ?>" width="20%" /></center>
<a href="<?php echo e(route('show')); ?>"><button style="width:15%;height:95%;margin-left:400px;margin-top:10px;" class="btn btn-primary">View All Customers</button></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('project.layoutpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\resources\views/project/index.blade.php ENDPATH**/ ?>